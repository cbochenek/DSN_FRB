...
CH1FREQ  = 2000.0+BW    # Channel 1 center frequenccy (MHz)
CH2FREQ  = 2000.0+BW    # Channel 2 center frequenccy (MHz)
CH3FREQ  = 1325.0+BW    # Channel 3 center frequenccy (MHz)
CH4FREQ  = 8100.0+BW    # Channel 4 center frequenccy (MHz)
CH1LABEL = "L-LCP"# "S-LCP"# Channel 1 band name
CH2LABEL = "L-RCP"# "S-RCP"# Channel 2 band name
CH3LABEL = "L-LCP"# "L-LCP"# Channel 3 band name
